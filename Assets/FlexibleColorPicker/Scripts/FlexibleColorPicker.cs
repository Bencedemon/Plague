...
public class FlexibleColorPicker : MonoBehaviour {
    ...
    */
    ...
    private void Awake() {
        ...
        startingColor = new Color(playerProfileManager.playerProfile.crosshairColor[0],playerProfileManager.playerProfile.crosshairColor[1],playerProfileManager.playerProfile.crosshairColor[2],playerProfileManager.playerProfile.crosshairColor[3]);
    }
