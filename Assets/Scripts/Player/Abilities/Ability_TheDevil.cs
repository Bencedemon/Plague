...
public class Ability_TheDevil : Ability
{
    ...
    [SerializeField] private PlayerProjectile fireBall;
    ...
    public override void UseAbility(){
        ...
        SpawnAbility(fireBall,_cameraTransform.position,_cameraTransform.forward,strength,range,duration);
    ...
    [ServerRpc]
    public virtual void SpawnAbility(PlayerProjectile _fireBall,Vector3 _point, Vector3 _normal,float _damage, float _range, float _duration){
        PlayerProjectile fireBall = Instantiate(_fireBall,_point,Quaternion.LookRotation(_normal));
        fireBall.trap.Initialize(_damage,_range,_duration,playerStats);
        ServerManager.Spawn(fireBall.gameObject);
        //fireBall.rb.AddForce(_normal*throwForce, ForceMode.Impulse);
    }
}
